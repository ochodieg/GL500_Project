...
// ------ Headlight detection ------
int headLightDetect   = 13;      // input to detect if hL is on
int headLightFlag;              // flag if hL is on

// -------- Brake Detection --------
int   brakeDetect     = 6;      // pin to detect if brake has been activated
...
int   rightTurn = 8; // input to detect if rT is active
